...
# chrome_options.add_argument("--headless=new")  # Corrected argument spelling
...
# TempDirPath = rf"{current_dir}/Forntend/Files"
...
#     english_translation = mt.translate(Text, "eng", "auto")
...
# Load environment variable for input language
env_vars = dotenv_values(".env")
...
def UniversalTranslator(Text):
    return mt.translate(Text, "eng", "auto").capitalize()
...
def SpeechRecognition():
    ...
    with sr.Microphone() as source:
        ...
        try:
            print("[Recognizing] Processing speech...")
